...
<body>
  ...
  <main class="main">
    ...
    <div class="content">
      ...
      <div style="background:#d4edda;border:1px solid #c3e6cb;border-radius:10px;padding:14px 20px;margin-bottom:20px;display:flex;align-items:center;gap:12px;color:#155724;font-size:14px;">
        ...
        <span>🎉 Welcome, <strong><?php echo htmlspecialchars($_SESSION['name'] ?? ''); ?></strong>! Your account is set up and ready to use.</span>
      </div>
      <?php endif; ?>
      <div class="tabs">
