...
<head>
  ...
  <link rel="stylesheet" href="../assets/hiyari-index.css"/>
</head>
<body>
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar__nav">
      ...
      <a href="index.php" class="nav-item nav-item--active" data-tooltip="Hiyari Hatto">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          <path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/>
          <line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/>
        </svg>
      </a>
      <a href="../kyt/index.php" class="nav-item" data-tooltip="KYT">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          <path d="M9 11l3 3L22 4"/>
          <path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/>
        </svg>
      </a>
      <a href="../departments.php" class="nav-item" data-tooltip="Departments">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <a href="../locations.php" class="nav-item" data-tooltip="Locations">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div class="sidebar__bottom">
      ...
      <a href="../auth/logout.php" class="nav-item nav-item--logout" data-tooltip="Sign Out">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  <main class="main">
    ...
    <div class="content">
      ...
      <div class="summary-row">
        ...
        <a href="?status=open" class="mini-card mini-card--red <?php echo $filter_status==='open' ? 'mini-card--active' : ''; ?>">
          <span class="mini-card__val"><?php echo $summary['open']; ?></span>
          <span class="mini-card__label">Open</span>
        </a>
        <a href="?status=in_progress" class="mini-card mini-card--yellow <?php echo $filter_status==='in_progress' ? 'mini-card--active' : ''; ?>">
          <span class="mini-card__val"><?php echo $summary['in_progress']; ?></span>
          <span class="mini-card__label">In Progress</span>
        </a>
        <a href="?status=closed" class="mini-card mini-card--green <?php echo $filter_status==='closed' ? 'mini-card--active' : ''; ?>">
          <span class="mini-card__val"><?php echo $summary['closed']; ?></span>
          <span class="mini-card__label">Closed</span>
        </a>
        <a href="?risk=extreme" class="mini-card mini-card--extreme <?php echo $filter_risk==='extreme' ? 'mini-card--active' : ''; ?>">
          <span class="mini-card__val"><?php echo $summary['extreme']; ?></span>
          <span class="mini-card__label">Extreme</span>
        </a>
        <a href="?risk=high" class="mini-card mini-card--orange <?php echo $filter_risk==='high' ? 'mini-card--active' : ''; ?>">
        ...
        <form method="GET" class="filter-form" id="filterForm">
          <div class="search-wrap">
            ...
            <input type="text" name="search" class="search-input"
              placeholder="Search report number or description..."
          ...
          <div class="filter-selects">
            ...
            <div class="date-range-wrap" id="customDateWrap" style="<?php echo $filter_date_range === 'custom' ? 'display:flex' : 'display:none'; ?>">
      ...
      <div class="table-box">
        ...
        <div class="pagination">
          ...
          <div class="pagination__btns">
            <?php if ($page > 1): ?>
            <a href="?<?php echo http_build_query(array_merge($_GET, ['page' => $page - 1])); ?>" class="page-btn">← Prev</a>
            <?php endif; ?>
