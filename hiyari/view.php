...
$status_badges = ['open' => 'badge--open', 'in_progress' => 'badge--progress', 'closed' => 'badge--closed'];
        ...
        <div class="view-left">
            ...
            <div class="view-card__body">
              <div class="info-grid">
                ...
                <div class="info-item">
                  ...
                  <span class="info-value"><?php echo htmlspecialchars($report['reporter_name'] ?? '—'); ?> <span style="color:var(--text-secondary);font-size:12px">(<?php echo htmlspecialchars($report['reporter_emp_id'] ?? ''); ?>)</span></span>
                </div>
                <div class="info-item">
          ...
          <div class="view-card">
            <div class="view-card__header">
              ...
              <h2 class="view-card__title">Corrective Actions <span class="table-count"><?php echo count($actions); ?></span></h2>
            </div>
            <div class="view-card__body">
              ...
              <div class="actions-list">
                ...
                <div class="action-item">
                  <div class="action-item__header">
                    <span class="action-item__num">#<?php echo $loop ?? ($loop = 1); $loop++; ?></span>
                    <span class="badge <?php echo $a['status'] === 'done' ? 'badge--closed' : ($a['status'] === 'progress' ? 'badge--progress' : 'badge--open'); ?>">
                    ...
                    <div class="action-item__btns">
                      ...
                      <a href="action_update?id=<?php echo $a['id']; ?>&report_id=<?php echo $id; ?>&status=done"
                        class="action-status-btn action-status-btn--done"
                  ...
                  <span class="action-item__assign">Assigned to: <strong><?php echo htmlspecialchars($a['assigned_name']); ?></strong></span>
                  <?php endif; ?>
                </div>
                <?php endforeach; ?>
              </div>
              ...
              <form method="POST" action="action_store.php" class="add-action-form">
                ...
                <div class="form-group">
                  ...
                  <textarea name="description" class="form-textarea" rows="2" placeholder="Describe the corrective action..." required></textarea>
                </div>
                <div class="form-row">
                  <div class="form-group">
        ...
        <div class="view-right">
          ...
          <div class="view-card view-card--comments">
            <div class="view-card__header">
              ...
              <h2 class="view-card__title">Comments <span class="table-count"><?php echo count($comments); ?></span></h2>
            </div>
            <div class="view-card__body">
              ...
              <div class="comments-list" id="commentsList">
                ...
                ?>
                <div class="comment <?php echo $is_own ? 'comment--own' : ''; ?> <?php echo $is_admin_comment ? 'comment--admin' : ''; ?>">
