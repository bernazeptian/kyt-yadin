          ...
          <form method="POST" action="profile_update">
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input type="text" class="form-input" value="<?php echo htmlspecialchars($user['employee_id']); ?>"
                  readonly />
              </div>
              <div class="form-group">
                <label class="form-label">Role</label>
                <input type="text" class="form-input" value="<?php echo $roleNames[$user['role']] ?? 'User'; ?>"
                  readonly />
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select name="position" class="form-select">
                ...
                <?php foreach ($positions as $p): ?>
                  <option value="<?php echo $p; ?>" <?php echo ($user['position'] ?? '') === $p ? 'selected' : ''; ?>>
                    <?php echo $p; ?>
                  </option>
                <?php endforeach; ?>
              </select>
