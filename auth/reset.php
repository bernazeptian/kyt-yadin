  ...
  <div class="wrap">
    <div class="card">
      ...
      <?php if (!empty($invalid)): ?>
        ...
        <a href="forgot" class="btn-submit"
          style="display:block;text-align:center;text-decoration:none;line-height:2.2;">Request New Link</a>
      ...
      <?php elseif ($error === 'mismatch'): ?>
        ...
        <a href="reset?token=<?php echo htmlspecialchars($token); ?>" class="btn-submit"
          style="display:block;text-align:center;text-decoration:none;line-height:2.2;">Try Again</a>
      ...
      <?php else: ?>
        ...
        <p class="sub">Hello <strong><?php echo htmlspecialchars($user['name']); ?></strong>, enter your new password
          below.</p>
        ...
        <form method="POST" action="reset_process">
          ...
          <div class="form-group">
            ...
            <div class="pw-wrap">
              <input type="password" class="form-input" name="password" id="pw1" placeholder="Min. 8 characters" required
                minlength="8" />
