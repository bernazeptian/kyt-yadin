  ...
  <main class="main">
            ...
            <div class="avatar-dropdown__info">
              ...
              <div>
                ...
                <div class="avatar-dropdown__role">
                  <?php $roleNames = [1=>'Super Admin',2=>'Admin',3=>'User']; echo $roleNames[(int)$_SESSION['role']] ?? 'Staff'; ?>
                </div>
              </div>
            </div>
    ...
    <div class="content">
      ...
      <!-- ══════════════════════════════════
           DEPARTMENTS TAB
      ══════════════════════════════════ -->
      <div class="tab-panel <?php echo $active_tab === 'departments' ? 'tab-panel--active' : ''; ?>" id="tab-departments">
        <div class="master-layout">
          <div class="master-form-box">
            ...
            <form method="POST" action="dept_store.php">
              <div class="form-group">
                ...
                <input type="text" name="code" class="form-input" placeholder="e.g. PROD" required maxlength="10" style="text-transform:uppercase"/>
              ...
              <div class="form-group">
                ...
                <select name="head_id" class="form-select">
                  ...
                  <option value="<?php echo $u['id']; ?>"><?php echo htmlspecialchars($u['name'] . ' (' . $u['employee_id'] . ')'); ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
              <div class="form-group">
                <label class="form-label">Description</label>
                <textarea name="description" class="form-textarea" rows="3" placeholder="Optional description..."></textarea>
              </div>
              <div class="form-group">
          ...
          <div class="master-list-box">
            <div class="master-list-box__header">
              <h2 class="master-list-box__title">Departments <span class="table-count"><?php echo count($departments); ?> records</span></h2>
            </div>
            ...
            <div class="table-wrap">
              <table class="table">
                <thead>
                  <tr><th>Code</th><th>Name</th><th>Head / PIC</th><th>Description</th><th>Status</th><th></th></tr>
                </thead>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><span class="badge <?php echo $d['is_active'] ? 'badge--closed' : 'badge--open'; ?>"><?php echo $d['is_active'] ? 'Active' : 'Inactive'; ?></span></td>
                    <td class="td-actions">
                      <button class="action-btn action-btn--edit" onclick="openEditDept(<?php echo htmlspecialchars(json_encode($d)); ?>)" title="Edit">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="15" height="15">
                          <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/>
                          <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
                        </svg>
                      </button>
                      <a href="dept_delete.php?id=<?php echo $d['id']; ?>" class="action-btn action-btn--delete" onclick="return confirm('Delete this department?')" title="Delete">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="15" height="15">
      ...
      <div class="tab-panel <?php echo $active_tab === 'locations' ? 'tab-panel--active' : ''; ?>" id="tab-locations">
        <div class="master-layout">
          <div class="master-form-box">
            ...
            <form method="POST" action="loc_store.php">
              <div class="form-group">
                ...
                <input type="text" name="code" class="form-input" placeholder="e.g. LOC001" required maxlength="10" style="text-transform:uppercase"/>
                <span class="form-hint">Max 10 characters</span>
              </div>
              <div class="form-group">
          ...
          <div class="master-list-box">
            <div class="master-list-box__header">
              <h2 class="master-list-box__title">Locations <span class="table-count"><?php echo count($locations); ?> records</span></h2>
            </div>
            ...
            <div class="table-wrap">
              <table class="table">
                <thead>
                  <tr><th>Code</th><th>Name</th><th>Description</th><th>Status</th><th></th></tr>
                </thead>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><span class="badge <?php echo $l['is_active'] ? 'badge--closed' : 'badge--open'; ?>"><?php echo $l['is_active'] ? 'Active' : 'Inactive'; ?></span></td>
                    <td class="td-actions">
                      <button class="action-btn action-btn--edit" onclick="openEditLoc(<?php echo htmlspecialchars(json_encode($l)); ?>)" title="Edit">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="15" height="15">
                          <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/>
                          <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
                        </svg>
                      </button>
                      <a href="loc_delete.php?id=<?php echo $l['id']; ?>" class="action-btn action-btn--delete" onclick="return confirm('Delete this location?')" title="Delete">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="15" height="15">
                          <polyline points="3 6 5 6 21 6"/>
                          <path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/>
                          <path d="M10 11v6"/><path d="M14 11v6"/>
      ...
      <div class="tab-panel <?php echo $active_tab === 'users' ? 'tab-panel--active' : ''; ?>" id="tab-users">
        <div class="master-layout">
          <div class="master-form-box">
            ...
            <form method="POST" action="user_store.php">
              <div class="form-group">
                ...
                <input type="text" name="employee_id" class="form-input" placeholder="e.g. EMP001" required maxlength="20"/>
              </div>
              <div class="form-group">
          ...
          <div class="master-list-box">
            <div class="master-list-box__header">
              <h2 class="master-list-box__title">Users <span class="table-count"><?php echo count($all_users); ?> records</span></h2>
            </div>
            ...
            <div class="table-wrap">
              <table class="table">
                <thead>
                  <tr><th>Employee ID</th><th>Name</th><th>Email</th><th>Role</th><th>Status</th><th></th></tr>
                </thead>
                <tbody>
                  <?php
                  ...
                  <tr>
                    ...
                    <td style="font-size:12px;color:var(--text-secondary)"><?php echo htmlspecialchars($u['email']); ?></td>
                    <td><span class="badge <?php echo $roleBadges[(int)$u['role']] ?? 'badge--low'; ?>"><?php echo $roleLabels[(int)$u['role']] ?? 'Staff'; ?></span></td>
                    <td><span class="badge <?php echo $u['is_active'] ? 'badge--closed' : 'badge--open'; ?>"><?php echo $u['is_active'] ? 'Active' : 'Inactive'; ?></span></td>
                    <td class="td-actions">
                      <button class="action-btn action-btn--edit" onclick="openEditUser(<?php echo htmlspecialchars(json_encode($u)); ?>)" title="Edit">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="15" height="15">
                          <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/>
                          <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
                        </svg>
                      </button>
                      <a href="user_reset_pw.php?id=<?php echo $u['id']; ?>" class="action-btn" style="color:var(--orange)"
                        onclick="return confirm('Reset password for <?php echo htmlspecialchars($u['name']); ?>?')" title="Reset Password">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="15" height="15">
                      ...
                      <a href="user_delete.php?id=<?php echo $u['id']; ?>" class="action-btn action-btn--delete"
                        onclick="return confirm('Delete user <?php echo htmlspecialchars($u['name']); ?>?')" title="Delete">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="15" height="15">
                          <polyline points="3 6 5 6 21 6"/>
                          <path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/>
                          <path d="M10 11v6"/><path d="M14 11v6"/>
  ...
  <div class="modal-overlay" id="editDeptModal">
    <div class="modal">
      ...
      <form method="POST" action="dept_update.php">
        ...
        <div class="form-group">
          <label class="form-label">Department Code <span class="required">*</span></label>
          <input type="text" name="code" id="editDeptCode" class="form-input" required maxlength="10" style="text-transform:uppercase"/>
        </div>
        <div class="form-group">
          <label class="form-label">Department Name <span class="required">*</span></label>
  ...
  <div class="modal-overlay" id="editLocModal">
    <div class="modal">
      ...
      <form method="POST" action="loc_update.php">
        ...
        <div class="form-group">
          <label class="form-label">Location Code <span class="required">*</span></label>
          <input type="text" name="code" id="editLocCode" class="form-input" required maxlength="10" style="text-transform:uppercase"/>
        </div>
        <div class="form-group">
          <label class="form-label">Location Name <span class="required">*</span></label>
