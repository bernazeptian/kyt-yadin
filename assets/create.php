...
$year      = date('Y');
$count     = $pdo->query("SELECT COUNT(*) FROM hiyari_reports WHERE YEAR(created_at) = $year")->fetchColumn();
$report_number = 'HH-' . $year . '-' . str_pad($count + 1, 3, '0', STR_PAD_LEFT);
          ...
          <div class="form-col">
              ...
              <div class="form-row">
                <div class="form-group">
                  ...
                  <input type="text" class="form-input form-input--readonly"
                    name="report_number" value="<?php echo htmlspecialchars($report_number); ?>" readonly/>
            ...
            <div class="form-section">
              ...
              <div class="upload-area" id="uploadArea">
                ...
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" width="36" height="36" class="upload-icon">
                  ...
                  <table class="matrix-table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="matrix-cell <?php echo $classMap[$val]; ?>"
                          data-l="<?php echo $row; ?>"
                          data-s="<?php echo $s + 1; ?>">
                          <?php echo $val; ?>
                        </td>
